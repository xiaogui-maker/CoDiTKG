...
class TimeConvTransR(torch.nn.Module):
    ...
    def forward(self, embedding, emb_rel, emb_time, triplets, nodes_id=None, mode="train", negative_rate=0,
...
class TimeConvTransE(torch.nn.Module):
    def __init__(self, num_entities, embedding_dim, input_dropout=0, hidden_dropout=0, feature_map_dropout=0,
        ...
        # self.time_wt_block = TimeWaveletBlock(embedding_dim, wt_levels=1, kernel_size=3)
