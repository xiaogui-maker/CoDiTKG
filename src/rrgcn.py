...
class RecurrentRGCN(nn.Module):
    def __init__(self, decoder_name, encoder_name, num_ents, num_rels,
                 ...
                 num_bases, num_basis,
                 num_hidden_layers, dropout, self_loop,
                 skip_connect, layer_norm, input_dropout,
                 hidden_dropout, feat_dropout, aggregation,
                 weight, discount, angle, use_static,
                 entity_prediction, relation_prediction,
                 use_cuda, gpu, analysis,
                 atc_K,
                 atc_alpha_s,
                 atc_alpha_l,
                 atc_decay_s,
                 atc_decay_l,
                 atc_anchor_loss_lambda,
                 atc_loss_weight,
                 use_anel,
                 anel_k_neighbors,
                 anel_time_window=,
                 use_inductive_diffusion,
                 use_time_decay,
                 use_multikernel_hawkes,
                 gru_beta,
                 gru_beta_fast,
                 gru_beta_slow,
                 diffusion_timesteps,
                 diffusion_sampling_steps,
                 diffusion_noise_level_seen=,
                 diffusion_noise_level_unseen,
                 ood_loss_weight,
                 diffusion_loss_weight,
                 distribution_loss_weight,
                 use_meta_learning,
                 meta_lr,
                 use_distribution_alignment,
                 alignment_strength):
